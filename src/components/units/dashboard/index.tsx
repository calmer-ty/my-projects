...
export default function DashboardUI() {
  ...
  return (
    <article className="">
      ...
      {/* Hero */}
      <section id="home" className="flex h-screen pt-16 snap-start">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 1.0, ease: "easeOut" }}
          className="flex justify-between w-full pt-40 pr-30 p-20"
        >
          {/* 글 내용 */}
          ...
          <div className="w-100 h-100 p-10 bg-white border border-gray-300 rounded-full shadow-lg">
            <img src="/images/sample.jpg" alt="sample" className="w-full h-full object-cover rounded-full z-10 shadow-lg" />
          </div>
        </motion.div>
      </section>

      {/* 프로젝트 */}
      <section id="projects" className="w-full h-screen pt-16 snap-start">
      ...
      {/* About (짧게) → 이 위치에 추가 */}
      <section id="about" className="w-full h-screen pt-16 snap-start">
