...
export const projects = [
  {
    id: "project-01",
    title: "Travel Diary",
    period: "나만의 여행 기록을 남기세요.",
    // desc: "원하는 장소에 방문일과 메모를 남기고, 북마크별로 메모를 관리하여 나만의 여행을 지도에 기록해보세요.",
    ...
    troubleshooting: {
      ...
      solution:
        "콘솔 로그를 통해 확인한 결과, 수정 모달이 열릴 때 북마크 상태값이 초기화되지 않아 발생한 문제였습니다. 이를 해결하기 위해 useEffect를 활용하여 모달 오픈 시점에 상태 초기화 로직을 추가해 해결했습니다.",
    },
    link: {
  ...
  {
    id: "project-02",
    title: "Vintage Management",
    period: "빈티지 상품, 이제 한 곳에서 관리하세요.",
    ...
    troubleshooting: {
      ...
      solution: "통화 정보와 환산 로직을 통합 관리할 수 있는 객체 기반 스키마를 설계하여 데이터 필드 구조를 단순화하고 활용도를 높였습니다.",
    },
    link: {
  ...
  },
  {
    ...
    troubleshooting: {
      ...
      solution: "지도 표시 전용 컴포넌트를 분리하고, 좌표 변환 로직은 별도의 커스텀 훅(useGeocode)으로 모듈화하여 기능별 독립성을 확보했습니다.",
    },
    link: {
