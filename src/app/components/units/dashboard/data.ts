...
export const projectsData = [
  {
    ...
    features: [
      ...
      {
        title: "북마크 설정에 따른 데이터 필터링",
        core: ["사용자가 원하는 북마크 직접 작성 가능.", "등록 데이터 북마크에 추가하여 관리 가능.", "북마크별로 원하는 정보 목록으로 확인 가능."],
        difficult: {
          problem: "북마크 추가 시, 해당 북마크에 맞는 데이터만 필터링하여 보여주는 기능을 구현하면서 데이터가 잘못 표시되는 문제가 발생했습니다.",
          solve:
            "다양한 기능과 북마크 기능이 한 컴포넌트에 집중되면서 필터링 로직이 복잡해졌다고 판단했습니다. 이에 북마크 기능을 별도의 컴포넌트로 분리하여 로직을 단순화하고 기능을 구현할 수 있었습니다.",
        },
        retrospect:
          "스스로가 아는 기능이더라도 컴포넌트 단위가 커지면 헷갈릴 수 있고 디버깅이 쉽지 않다는걸 느꼈습니다. 앞으로 작업 시 예상되는 기능들을 미리 컴포넌트로 분리하는 습관을 들여야겠다고 생각했습니다.",
      },
      {
        title: "사용자가 사용할 수 있는 게임들",
        core: ["주사위 게임", "룰렛 돌리기."],
        difficult: { problem: "???.", solve: "???." },
        retrospect: "???.",
      },
    ],
  },
